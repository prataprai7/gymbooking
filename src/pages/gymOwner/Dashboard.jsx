...
const Dashboard=()=>{
    ...
    return(
        <div>
            ...
            subTitle='Monitor your gym listings, track bookings and
             analyze revenue-all in one place. Stay updated with real-time 
            ...
            <h2 className='text-xl text-blue-950/70 font-medium mb-5'>Recent Bookings</h2>
                ...
                <thead className='bg-gray-50'>
                    <tr>
                        ...
                        <th className='py-3 px-4 text-gray-800 font-medium max-sm:hidden'>Gym Name</th>
