...
const AddRoom=()=>{
    ...
    return(
        < form>
            <Title align='left' font='outfit' title='Add Gym' subTitle='Fill in the details carefully and accurate
            gym details, pricing, and amenities to enhance the user booking experience.' />
            ...
            <div className='grid grid-cols-2 sm:flex gap-4 my-2 flex-wrap'>
                {Object.keys(images).map ((key)=>(
                    <label htmlFor={`roomImage${key}`} key={key}>
                        ...
                        src={images[key] ? URL.create0bjectURL(images[key]) : assets.
                        uploadArea} alt=""/>
            ...
            <div className='w-full flex max-sm:flex-col sm:gap-4 mt-4'>
                ...
                <div>
                    ...
                    value={inputs.pricePerMonth} onChange={e=> setInputs({...inputs, pricePerMonth: e.target.value})}/>
                </ div>
            </div>
            ...
            <div className='flex flex-col flex-wrap mt-1 text-gray-400 max-w-sm' >
                {Object.keys(inputs.amenities).map((amenity, index)=>(
                    <div key={index}>
                        ...
                        {inputs.amenities [amenityl]} onChange={()=>setInputs({...inputs,
