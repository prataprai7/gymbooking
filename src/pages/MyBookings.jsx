...
const MyBooking=()=>{
    ...
    return(
        <dev className='py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>

            <Title title='My Bookings' subTitle='Easily manage your past, current, 
            and upcoming gym reservations in one place. Plan your trainings seamlessly 
            with just a few clicks' align='left' />
            ...
            <div className='max-w-6x1 mt-8 w-full text-gray-800'>
                ...
                {bookings.map((booking)=>(
                    ...
                    [3fr_2fr_1fr] w-full border-b border-gray-300
                    py-6 first:border-t'>
                        {/*Gym Details */}
                        ...
                        <div className='flex flex-row md:items-center md:gap-12 mt-3 gap-8' >
                            <div>
                                <p>Check-In:</p>
                                <p className= 'className="text-gray-500 text-sm"' > {new Date(booking.checkInDate).toDateString()}
                                </p>
                            </div>
                            <div>
                                <p>Check-Out:</p>
                                <p className='className="text-gray-500 text-sm"'> {new Date(booking.checkOutDate).toDateString()}
                                </p>
                            </div>
                        </div>
                        {/*Payment status */}
